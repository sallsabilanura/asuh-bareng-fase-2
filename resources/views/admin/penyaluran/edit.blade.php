<x-app-layout>
    <div class="sm:flex sm:items-center mb-6">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-bold text-gray-900">Edit Penyaluran Dana</h1>
            <p class="mt-2 text-sm text-gray-700">Perbarui nominal atau catatan penyaluran dana anak asuh.</p>
        </div>
            ...
            <form action="{{ route('penyaluran.update', $penyaluran->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="mt-1">
                            <select id="AnakAsuhID" name="AnakAsuhID" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">
                                ...
                                @foreach($anakAsuhs as $anak)
                                    <option value="{{ $anak->id }}" {{ old('AnakAsuhID', $penyaluran->AnakAsuhID) == $anak->id ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <select id="Bulan" name="Bulan" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">
                                @for($i=1; $i<=12; $i++)
                                    <option value="{{ $i }}" {{ old('Bulan', $penyaluran->Bulan) == $i ? 'selected' : '' }}>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" name="Tahun" id="Tahun" value="{{ old('Tahun', $penyaluran->Tahun) }}" required
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <!-- removing the `.00` by formatting correctly directly from model or cast-->
                            <input type="number" name="Nominal" id="Nominal" value="{{ old('Nominal', (int) $penyaluran->Nominal) }}" required
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="Keterangan" name="Keterangan" rows="2"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm">{{ old('Keterangan', $penyaluran->Keterangan) }}</textarea>
                        </div>
                    </div>
                </div>
